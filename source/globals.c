...
TriggerMeta g_triggers[MAX_TRIGGERS];
int g_trigger_count = 0;
uint8_t g_event_flags[MAX_EVENT_FLAGS];
SynthPattern g_audio_patterns[MAX_SYNTH_PATTERNS];
int g_audio_pattern_count = 0;
bool g_audio_enabled = true;
uint8_t g_audio_last_event = AUDIO_EVENT_NONE;
float g_audio_event_timer = 0.0f;
uint8_t g_level_music_id = AUDIO_ID_MUSIC;
WeaponDef g_weapons[MAX_WEAPONS] = {
    {"SWORD", 3, 1, 20, 1, {0x10,0x18,0x18,0x10,0x10,0x54,0x38,0x10}, AUDIO_ID_ATTACK},
    {"DAGGER", 2, 1, 11, 2, {0x00,0x08,0x18,0x18,0x10,0x10,0x38,0x10}, AUDIO_ID_ATTACK},
    {"KNIFE", 2, 1, 14, 3, {0x04,0x0C,0x1C,0x18,0x10,0x10,0x30,0x20}, AUDIO_ID_ATTACK},
    {"MACE", 5, 1, 34, 5, {0x18,0x3C,0x18,0x18,0x18,0x18,0x18,0x10}, AUDIO_ID_ATTACK},
    {"MALLET", 7, 1, 46, 6, {0x7E,0x7E,0x18,0x18,0x18,0x18,0x18,0x10}, AUDIO_ID_ATTACK},
    {"AXE", 6, 1, 38, 4, {0x38,0x7C,0x58,0x18,0x18,0x18,0x18,0x10}, AUDIO_ID_ATTACK},
    {"SPEAR", 4, 2, 28, 7, {0x10,0x38,0x10,0x10,0x10,0x10,0x10,0x10}, AUDIO_ID_ATTACK},
    {"STAFF", 3, 3, 32, 0, {0x18,0x24,0x18,0x18,0x18,0x18,0x18,0x18}, AUDIO_ID_ATTACK}
};
